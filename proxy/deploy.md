...
<Info title="No Limits on LiteLLM OSS">
...
<Info title="Facing issues with pulling the docker image? Email us at support@berri.ai.">
...
<Tab title="LiteLLM CLI (pip package)">
...
<Tab title="Docker Compose (Proxy + DB)">
...
<Info title="To avoid issues with predictability, difficulties in rollback, and inconsistent environments, use versioning or SHA digests (for example, `litellm:main-v1.30.3` or `litellm@sha256:12345abcdef...`) instead of `litellm:main-stable`.">
...
<Info title="[BETA] Helm Chart is BETA. If you run into an issues/have feedback please let us know [https://github.com/BerriAI/litellm/issues](https://github.com/BerriAI/litellm/issues)">
...
<Info title="💡 Go here 👉 [to make your first LLM API Request](user_keys)">
...
<Warning title="High Traffic Deployments (1000+ RPS)">
...
<Tab title="Helm OCI Registry (GHCR)">
...
<Tabs>
<Tab title="AWS ECS - Elastic Container Service">
...
<Tab title="AWS Cloud Formation Stack">
