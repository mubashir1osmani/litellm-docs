...
# ✨ Enterprise Features
<Tip title="To get a license, get in touch with us [here](https://calendly.com/d/cx9p-5yf-2nm/litellm-introductions)">
...
<Tab title="Invalid Request (No `user` passed)">
...
<Tab title="Invalid Request (No `metadata` passed)">
...
<Tip title="For comprehensive spend tracking features including budgets, alerts, and detailed analytics, check out [Spend Tracking](https://docs.litellm.ai/docs/proxy/cost_tracking).">
...
<Info title="The `hide_secrets` guardrail check did not run on this request because api key=sk-jNm1Zar7XfNdZXp49Z1kSQ has `&quot;permissions&quot;: {&quot;hide_secrets&quot;: false}`">
...
<Info title="Requires a LiteLLM Enterprise key to use. Get a free 2-week license [here](https://forms.gle/sTDVprBs18M4V8Le8)">
...
<Info title="[Suggest a way to improve this](https://github.com/BerriAI/litellm/issues/new/choose)">
...
<Info title="In production we recommend setting a `max_request_size_mb` /  `max_response_size_mb` around `32 MB`">
