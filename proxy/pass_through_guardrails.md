...
![Add guardrails to pass-through endpoint](/images/pt_guard1.png)
...
![Configure field-level targeting](/images/pt_guard2.png)
...
<Info title="If the `guardrails` block is omitted or empty in your pass-through endpoint config, the request skips the guardrail flow entirely and goes directly to the target API.">
