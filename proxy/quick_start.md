...
<Info title="Run with `--detailed_debug` if you need detailed debug logs">

Run `litellm --model huggingface/bigcode/starcoder --detailed_debug` for detailed debug logs.
...
<Tab title="Huggingface (TGI) Deployed">
...
<Tab title="Huggingface (TGI) Local">
...
<Info title="LiteLLM is compatible with several SDKs - including OpenAI SDK, Anthropic SDK, Mistral SDK, LLamaIndex, Langchain (Js, Python)">
...
<Tab title="Langchain Embeddings">
