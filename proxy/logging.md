...
<Info title="Dynamic request message redaction is in BETA.">
...
![](/images/message_redaction_logging.png)

**Spend Logs**

![](/images/message_redaction_spend_logs.png)
...
<Info title="Disable this by setting `global_disable_no_log_param:true` in your config.yaml file.">
...
<Info title="This is an enterprise feature.">
...
<Tab title="OpenAI Python v1.0.0+">
...
![](/images/debug_langfuse.png)

## OpenTelemetry

<Info title="[Optional] Customize OTEL Service Name and OTEL TRACER NAME by setting the following variables in your environment">
...
<Tab title="Log to Traceloop Cloud">
...
<Tab title="Log to OTEL HTTP Collector">
...
<Tab title="Log to OTEL GRPC Collector">
...
<Warning title="Only use this for self hosted LLMs, this can cause Bedrock, VertexAI calls to fail">
...
<Info title="✨ This is an Enterprise only feature [Get Started with Enterprise here](https://calendly.com/d/cx9p-5yf-2nm/litellm-introductions)">
...
![](/images/deepeval_visible_trace.png)
...
![](/images/callback_api.png)
<p style={{textAlign: 'left', color: '#666'}}>
  Send LiteLLM logs to a custom API endpoint
</p>

<Info title="This is an Enterprise only feature [Get Started with Enterprise here](https://github.com/BerriAI/litellm/tree/main/enterprise)">
...
<Info title="`thresholds` are not required by default, but you can tune the values to your needs.">
