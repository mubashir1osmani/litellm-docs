...
<Info title="This key can only make requests to `models` that are `gpt-3.5-turbo` or `gpt-4`">
...
<Tab title="Disallowed Access">

<Info title="Expect this to fail since gpt-4o is not in the `models` for the key generated">
...
<Tab title="Context Window Fallbacks">
...
<Tab title="Content Policy Fallbacks">
