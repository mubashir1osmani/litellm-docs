...
<Tab title="UI (LiteLLM Dashboard)">
...
<Info title="✨ Enterprise only feature for team/key-based policy attachments. [Get a free trial](https://www.litellm.ai/enterprise#trial)">
...
![](/images/policy_test_matching.png)
