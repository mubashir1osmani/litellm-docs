...
![Select LiteLLM Content Filter](/images/create_guard.gif)
...
![Select prebuilt entities or add custom regex](/images/add_Guard2.gif)
...
![Add blocked keywords](/images/create_guard3.gif)
...
![Test guardrail in playground](/images/add_guard5.gif)
...
<Tabs>
<Tab title="Harmful Content Detection">
...
<Warning title="This can introduce significant latency to the request - depending on the speed of the vision-capable model.">
...
<Info title="Bias Detection Considerations">
