...
<Tab title="LiteLLM Docker (container)">
...
<Note title="If the policy input rules redact a sensitive value, you will not see redaction applied by the output rules in this test.">
...
<Tab title="Allowed request and response">
