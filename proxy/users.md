...
<Info title="**Budget Setup Options**">
...
<Info title="**Step-by step tutorial on setting, resetting budgets on Teams here (API or using Admin UI)**">
...
<Info title="✨ This is an Enterprise only feature [Get Started with Enterprise here](https://www.litellm.ai/#pricing)">
...
<Tab title="Per API Key Per model">
...
<Info title="You can also create a budget id for a customer on the UI, under the 'Rate Limits' tab.">
