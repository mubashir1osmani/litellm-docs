...
<Info title="Use [Email Notifications](./email.md) to email users onboarding links">

</Info>

3. User logs in via email + password auth

![](/images/ui_clean_login.png)



<Info title="LiteLLM Enterprise: Enable [SSO login](./ui.md#setup-ssoauth-for-ui)">
...
![](/images/ui_self_serve_create_key.png)
...
![](/images/ui_invite_user.png)
<br />

2. Share invitation link with user


![](/images/ui_invite_link.png)
<br />
...
<Info title="Team must be created before setting it as the default team.">
...
![](/images/create_team_member_rate_limits.png)
