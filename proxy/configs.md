...
```
<Info title="For more provider-specific info, [go here](../providers/)">
...
<Tip title="Run with `--detailed_debug` if you need detailed debug logs">
...
<Tabs>
<Tab title="Bedrock Completion/Chat">
...
<Tab title="Sagemaker, Bedrock Embeddings">
...
<Tab title="Hugging Face Embeddings">
...
<Tab title="Azure OpenAI Embeddings">
...
<Tab title="OpenAI Compatible Embeddings">
...
<Info title="For more on this, go to [this page](https://docs.litellm.ai/docs/proxy/load_balancing)">
