...
<Info title="All routes are prefixed with your LiteLLM proxy base URL: `https://<litellm-proxy-base-url>`">
...
![](/images/passthrough_query_default.png)
...
![](/images/passthrough_method_setup.png)
