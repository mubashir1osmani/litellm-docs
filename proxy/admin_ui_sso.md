...
<Info title="From v1.76.0, SSO is now Free for up to 5 users.">

</Info>

<Info title="✨ SSO is on LiteLLM Enterprise">
...
![](/images/okta_security_api.png)

2. Select the **default** authorization server (or your custom one)

![](/images/okta_authorization_server.png)
...
![](/images/okta_access_policies.png)
...
<Tip title="You can find all OAuth endpoints at `https://<your-okta-domain>/.well-known/openid-configuration`">
...
<Tab title="Generic SSO Provider">
...
![](/images/litellm_ui_admin.png)

<Info title="If you don't see all your keys this could be due to a cached token. So just re-login and it should work.">
...
<div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
  ![](/images/admin_settings_ui_theme.png)
  ![](/images/admin_settings_ui_theme_logo.png)
</div>
