...
<Tip title="LiteLLM follows the [Mistral API request/response for the OCR API](https://docs.mistral.ai/capabilities/vision/#optical-character-recognition-ocr)">
...
<Info title="LiteLLM follows the **Mistral OCR API specification**.">
