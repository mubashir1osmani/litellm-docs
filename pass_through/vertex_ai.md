...
<Tabs>
<Tab title="Specific Project/Region">
...
<Tab title="Set in environment variables">
...
<Info title="The `x-pass-` prefix works for all LLM pass-through endpoints, not just Vertex AI.">
