...
<Warning title="Important: Only Search Models Support `web_search_options`">
...
<Tip title="The `web_search_options` parameter is optional">
...
<Info title="**Anthropic Web Search Models**: Claude models that support web search: `claude-3-5-sonnet-latest`, `claude-3-5-sonnet-20241022`, `claude-3-5-haiku-latest`, `claude-3-5-haiku-20241022`, `claude-3-7-sonnet-20250219`">
...
<Tip title="Search models search automatically">
...
<Info title="Search-dedicated models like `gpt-5-search-api` and `gpt-4o-search-preview` do **not** support the `/responses` endpoint. Use them with `/chat/completions` + `web_search_options` instead (see above).">
...
<Tab title="Custom Search Context">
