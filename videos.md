...
<Tip title="LiteLLM follows the [OpenAI Video Generation API specification](https://platform.openai.com/docs/guides/video-generation)">
...
<Info title="LiteLLM follows the **OpenAI Video Generation API specification**.">
