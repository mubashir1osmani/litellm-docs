...
<Tip title="LiteLLM follows the [A2A (Agent-to-Agent) Protocol](https://github.com/google/A2A) for invoking agents.">
...
![](/images/a2a_trace_grouping.png)

**Agent Spend Attribution:**

![](/images/a2a_agent_spend.png)
