...
<Tip title="Looking for how to use Code Interpreter? See the [Code Interpreter Guide](/docs/guides/code_interpreter).">
...
<Tip title="Containers provide isolated execution environments for code interpreter sessions. You can create, list, retrieve, and delete containers.">
...
<Info title="Currently, only OpenAI supports container management for code interpreter sessions. Support for additional providers may be added in the future.">
