...
<Tip title="After ingesting documents, use [/rag/query](./rag_query.md) to search and generate responses with your ingested content.">
...
<Info title="Bedrock Auto-Creation">
...
<Info title="Vertex AI Prerequisites">
...
<Info title="S3 Vectors Auto-Creation">
