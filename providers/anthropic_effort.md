...
<Tab title="Claude Opus 4.5 (beta)">
...
<Info title="`effort=&quot;max&quot;` is only available on Claude Opus 4.6. Using it with other models will raise a validation error.">
