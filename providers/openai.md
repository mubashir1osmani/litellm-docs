...
<Tip title="**We recommend using `litellm.responses()` / Responses API** for the latest OpenAI models (GPT-5, gpt-5-codex, o3-mini, etc.)">
...
<Info title="Metadata passthrough (preview)">
...
<Tab title="config.yaml - proxy all OpenAI models">
...
<Tabs>
<Tab title="SDK - /chat/completions">
...
<Tab title="litellm.completion + stream">
