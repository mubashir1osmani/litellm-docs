...
<Info title="Selecting `openai` as the provider routes your request to an OpenAI-compatible endpoint using the upstream">
...
1. Modify the config.yaml 
  ...
  <Info title="If you see `Not Found Error` when testing make sure your `api_base` has the `/v1` postfix">
