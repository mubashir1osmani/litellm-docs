...
<Info title="See full guide on Reasoning with LiteLLM [here](../reasoning_content)">
...
<Info title="For more information about passing provider-specific parameters, [go here](../completion/provider_specific_params.md)">
