...
<Tip title="**We support ALL xAI models, just set `model=xai/<any-model-on-xai>` as a prefix when sending litellm requests**">
...
<Tab title="LiteLLM Proxy - OpenAI SDK Usage">
