...
<Tip title="Vertex AI vs Gemini API">
...
1. Modify the config.yaml 
  ...
  <Tab title="Different location per model">
  ...
  <Tab title="One location all vertex models">
...
<Tab title="Images with direct links">
...
<Tab title="LiteLLM PROXY (Unified Endpoint)">
...
<Tab title="LiteLLM PROXY (Vertex SDK)">
...
<Info title="Trying to deploy LiteLLM on Google Cloud Run? Tutorial [here](https://docs.litellm.ai/docs/proxy/deploy#deploy-on-google-cloud-run)">

</Info>

1. Figure out the Service Account bound to the Google Cloud Run service

![](/images/gcp_acc_1.png)
