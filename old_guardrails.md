...
<Info title="Since `pii_masking` is default Off for all requests, [you can switch it on per API Key](#switch-guardrails-onoff-per-api-key)">
...
<Info title="If you need to switch `pii_masking` off for an API Key set `&quot;permissions&quot;: {&quot;pii_masking&quot;: false}` with either `/key/generate` or `/key/update`">
...
<Info title="The `pii_masking` guardrail ran on this request because api key=sk-jNm1Zar7XfNdZXp49Z1kSQ has `&quot;permissions&quot;: {&quot;pii_masking&quot;: true}`">
