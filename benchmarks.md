...
{/* ![](/images/1_instance_proxy.png) */}

{/* ## **Horizontal Scaling - 10K RPS**

![](/images/instances_vs_rps.png)
...
<Tip title="Use `redis_host`, `redis_port`, and `redis_password` instead of `redis_url` for ~80 RPS better performance.">
