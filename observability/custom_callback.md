...
<Info title="**For PROXY** [Go Here](../proxy/logging.md#custom-callback-class-async)">
...
<Info title="For the complete logging payload specification, see the [Standard Logging Payload Spec](https://docs.litellm.ai/docs/proxy/logging_spec).">
