...
![](/images/langfuse-example-trace-multiple-models-min.png)


<Info title="For Langfuse v3, we recommend using the [Langfuse OTEL](./langfuse_otel_integration) integration.">
