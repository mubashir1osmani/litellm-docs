...
<Tip title="Setting Up a Fake OpenAI Endpoint">
...
<Info title="All requests with `model=&quot;gemini-vision&quot;` will be load balanced equally across the 2 deployments.">
...
5. Run Load test on locust
  ...
  ![](/images/locust_load_test2_setup.png)
