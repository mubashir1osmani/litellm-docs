...
3. **Configure the Secret Manager**  
   ...
   ![](/images/secret_manager_settings.png)

4. **Create the team**  
   Review the inputs and click `Create Team` to save.  
   
   ![](/images/secret_manager_settings_create_button.png)
