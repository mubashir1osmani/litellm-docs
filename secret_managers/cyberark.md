...
![Creating virtual key in LiteLLM UI](/images/cyberark1.png)
...
![Virtual key stored in CyberArk API](/images/cyberark2.png)
...
<Warning title="Disabling SSL verification is insecure and should only be used for testing or development environments with self-signed certificates. For production, configure your certificate chain properly or use certificate-based authentication with `CYBERARK_CLIENT_CERT` and `CYBERARK_CLIENT_KEY`.">
