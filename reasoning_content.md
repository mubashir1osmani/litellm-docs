...
<Info title="Requires LiteLLM v1.63.0+">
...
<Tip title="LiteLLM supports thinking_blocks">
...
<Info title="When `modify_params=True` and LiteLLM drops the `thinking` param, the model will **not** use extended thinking for that specific turn. The conversation will continue normally, but without reasoning for that response.">
