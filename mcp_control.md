...
<Tabs>
<Tab title="Only Allow Specific Tools">
...
<Tab title="Block Specific Tools">
...
![MCP server configuration in Admin UI](/images/mcp_allow_all_ui.png) 
...
![](/images/mcp_create_access_group.png)
...
![](/images/mcp_key_access_group.png)
...
<Note title="Permissions still apply">
