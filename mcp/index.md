...
<Warning title="MCP protocol update">
...
<Tab title="Dynamically on Client Side">
...
<Tip title="Works with all providers">
...
<Tab title="OpenAI SDK + LiteLLM Proxy">
