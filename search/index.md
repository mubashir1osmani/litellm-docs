...
<Tip title="LiteLLM follows the [Perplexity API request/response for the Search API](https://docs.perplexity.ai/api-reference/search-post)">

</Tip>

<Info title="Supported from LiteLLM v1.78.7+">
...
<Info title="LiteLLM follows the **Perplexity Search API specification**.">
