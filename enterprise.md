...
<Info title="- ✨ SSO is free for up to 5 users. After that, an enterprise license is required. [Get Started with Enterprise here](https://www.litellm.ai/enterprise)">
...
<Info title="Get free 7-day trial key [here](https://www.litellm.ai/enterprise#trial)">
...
![](/images/enterprise_vs_oss_2.png)
...
![](/images/litellm_hosted_ui_create_key.png)

### 2. Add Models

![](/images/litellm_hosted_ui_add_models.png)

### 3. Track spend 

![](/images/litellm_hosted_usage_dashboard.png)


### 4. Configure load balancing 

![](/images/litellm_hosted_ui_router.png)
